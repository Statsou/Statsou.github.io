...
!(function (e, t) {
  ...
  function I(e) {
      ...
      if (t.allowClick) {
          ...
          t.updateClickedSlide((e && e[0]) || o.target), t.emit("tap click", o), c < 200 && d - s.lastClickTime < 200 && t.emit("doubleTap doubleClick", o);
      }
      if (
          ((s.lastClickTime = u()),
          p(() => {
              ...
              t.params.cssMode && ((t.wrapperEl.style.overflow = "hidden"), (t.wrapperEl.style.touchAction = "none")),
                  ...
                  e
                      ? (($ = m.$slideEl[0].offsetWidth),
                        ...
                        g > T && (g = T))
                      : ((h = 0), (g = 0)),
                  m.$imageWrapEl.transition(200).transform(`translate3d(${h}px, ${g}px,0)`),
                  m.$imageEl.transition(200).transform(`translate3d(0,0,0) scale(${s.scale})`);
          }
          function $() {
              const e = t.zoom,
                  s = t.params.zoom;
                              ...
                              if (r.freeMode.momentum) {
                                  if (d.velocities.length > 1) {
                                      const e = d.velocities.pop(),
                                          ...
                                          i = e.time - s.time;
                                      (t.velocity = a / i), (t.velocity /= 2), Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (i > 150 || u() - e.time > 200) && (t.velocity = 0);
                                  } else t.velocity = 0;
