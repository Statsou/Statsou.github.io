...
var _activeMenu = require("./utils/active-menu");
var _modalFocus = require("./utils/modal-focus");
var _swiperHero = require("./utils/swiper-hero");
var _swiperPrograms = require("./utils/swiper-programs");
var _swiperNews = require("./utils/swiper-news");
var _swiperReviews = require("./utils/swiper-reviews");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swiperHero.addSwiperHero)();
  (0, _swiperPrograms.addSwiperPrograms)();
  (0, _swiperNews.addSwiperNews)();
  (0, _swiperReviews.addSwiperReviews)();
  (0, _maps.addMaps)();
  (0, _modalFocus.activeFocus)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/select/custom-select":14,"./utils/active-menu":17,"./utils/ios-vh-fix":20,"./utils/maps":21,"./utils/modal-focus":22,"./utils/swiper-hero":24,"./utils/swiper-news":25,"./utils/swiper-programs":26,"./utils/swiper-reviews":27}],2:[function(require,module,exports){
"use strict";
...
var Modals = /*#__PURE__*/function () {
  function Modals() {
    ...
    _defineProperty(this, "startFocus", void 0);
...
},{"../../utils/focus-lock":18,"../../utils/scroll-lock":23}],13:[function(require,module,exports){
"use strict";
  ...
  var V = /*#__PURE__*/function () {
    ...
    _createClass(V, [{
      ...
      value: function slidesPerViewDynamic(e, t) {
        ...
        } else if ("current" === e) for (var _e43 = l + 1; _e43 < a.length; _e43 += 1) (t ? i[_e43] + r[_e43] - i[l] < n : i[_e43] - i[l] < n) && (o += 1);else for (var _e44 = l - 1; _e44 >= 0; _e44 -= 1) i[l] - i[_e44] < n && (o += 1);
        return o;
      }
    }, {
      key: "update",
        ...
        t.loadImage(n[0], c || l, p, u, !1, function () {
          if (null != t && t && (!t || t.params) && !t.destroyed) {
            if (l ? (n.css("background-image", "url(\"".concat(l, "\")")), n.removeAttr("data-background")) : (p && (n.attr("srcset", p), n.removeAttr("data-srcset")), u && (n.attr("sizes", u), n.removeAttr("data-sizes")), h.length && h.children("source").each(function (e) {
              ...
              r.hasClass(t.params.slideDuplicateClass) ? o(t.$wrapperEl.children("[data-swiper-slide-index=\"".concat(_e64, "\"]:not(.").concat(t.params.slideDuplicateClass, ")")).index(), !1) : o(t.$wrapperEl.children(".".concat(t.params.slideDuplicateClass, "[data-swiper-slide-index=\"").concat(_e64, "\"]")).index(), !1);
            }
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _l9 = 0; _l9 < e.length; _l9 += 1) {
          ...
          _o8[0].style.zIndex = -Math.abs(Math.round(_d7)) + e.length, se(a, _o8).transform(_E);
        }
      },
      setTransition: function setTransition(e) {
...
var activeMenu = function activeMenu() {
  ...
  var headerOverlay = document.querySelector('.main-header__overlay');
  var navigation = document.querySelector('.main-header__navigation');
  var menuList = navigation.querySelector('.main-header__menu-list');
  var menuLinks = menuList.querySelectorAll('.main-header__menu-link');
  var subMenuButtons = menuList.querySelectorAll('.main-header__sub-menu-button');
  var subMenuLists = menuList.querySelectorAll('.main-header__sub-menu-list');
  var subMenuLinks = menuList.querySelectorAll('.main-header__sub-menu-link');
  var menuButton = navigation.querySelector('.main-header__navigation-button');
  var iconBurger = menuButton.querySelector('.main-header__burger-icon');
  var iconClose = menuButton.querySelector('.main-header__close-icon');
  var menu = navigation.querySelector('.main-header__menu');
  var menuElements = [];
  if (document.querySelector('.main-header__overlay') && document.querySelector('.main-header__navigation') && navigation.querySelector('.main-header__navigation-button') && menuButton.querySelector('.main-header__burger-icon') && menuButton.querySelector('.main-header__close-icon') && navigation.querySelector('.main-header__menu-list') && menuList.querySelectorAll('.main-header__sub-menu-list')) {
    menuElements.push(headerOverlay, navigation, menuButton, iconBurger, iconClose);
    menu.close();
    navigation.classList.add('is-active');
    menuButton.classList.add('is-active');
    header.classList.add('is-active');
    subMenuLists.forEach(function (menu) {
  ...
  function openMenu() {
    if (menuElements.length !== 0 && subMenuLists !== 0 && subMenuButtons !== 0) {
      ...
      subMenuButtons.forEach(function (title) {
  ...
  if (subMenuButtons !== 0) {
    subMenuButtons.forEach(function (title) {
      var siblingList = title.nextElementSibling;
...
exports.addMaps = void 0;
var addMaps = function addMaps() {
  ...
  var mapInitial = function mapInitial() {
    ...
    map.addLayer(layer);
    var marker = L.marker({
      lat: 55.02861756934401,
      lng: 82.9282250991378
    }, markerOptions);
    marker.addTo(map);
  };
  mapInitial();
...
exports.activeFocus = void 0;
var activeFocus = function activeFocus() {
  var modal = document.querySelector('.modal');
  function modalFocus() {
    var startElement = modal.querySelector('[data-focus]');
    if (startElement) {
      startElement.focus();
    }
  }
...
},{"./ios-checker":19}],24:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSwiperHero = void 0;
var _swiperNew = _interopRequireDefault(require("../swiper-new"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addSwiperHero = function addSwiperHero() {
  var swiperSettings = new _swiperNew.default('.slider-hero', {
    loop: true,
...
exports.addSwiperHero = addSwiperHero;

},{"../swiper-new":16}],25:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSwiperNews = void 0;
var _swiperNew = _interopRequireDefault(require("../swiper-new"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addSwiperNews = function addSwiperNews() {
  var initialSwiper = function initialSwiper() {
    swiperSettings = new _swiperNew.default('.swiper-news', {
      loop: false,
      watchSlidesVisibility: true,
  ...
  var controlsList = document.querySelector('.news__filter-list');
  var sliderList = document.querySelector('.slider-news__list');
  var controls = controlsList.querySelectorAll('.news__filter-button');
  var slides = sliderList.querySelectorAll('.slider-news__item');
  var swiperSettings = null;
  initialSwiper();
...
exports.addSwiperNews = addSwiperNews;

},{"../swiper-new":16}],26:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSwiperPrograms = void 0;
var _swiperNew = _interopRequireDefault(require("../swiper-new"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addSwiperPrograms = function addSwiperPrograms() {
  var swiperSettings = new _swiperNew.default('.swiper-programs', {
    loop: false,
    watchSlidesVisibility: true,
    watchSlidesProgress: false,
    slidesPerView: 1,
...
exports.addSwiperPrograms = addSwiperPrograms;

},{"../swiper-new":16}],27:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSwiperReviews = void 0;
var _swiperNew = _interopRequireDefault(require("../swiper-new"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addSwiperReviews = function addSwiperReviews() {
  var swiperSettings = new _swiperNew.default('.swiper-reviews', {
    loop: false,
    watchSlidesVisibility: true,
    watchSlidesProgress: false,
    slidesPerView: 1,
...
exports.addSwiperReviews = addSwiperReviews;
