...
function focusElementinOpenFeedback(nameModal) {
  var modal = document.querySelector("[data-modal=".concat(nameModal, "]"));
  if (modal.classList.contains('is-active')) {
    setTimeout(function () {
      modal.querySelector('[data-focus=data-focus]').focus();
    }, 100);
  }
}
;
var settings = {
  ...
  'feedback': {
    openCallback: function openCallback() {
      return focusElementinOpenFeedback('feedback');
    }
  }
};
    ...
    subMenuButtons.forEach(function (title) {
      ...
      title.addEventListener('click', function () {
        if (siblingList.classList.contains('enabled')) {
          setTimeout(function () {
            siblingList.classList.remove('enabled');
          }, 300);
...
},{"../swiper-new":16}],24:[function(require,module,exports){
"use strict";
